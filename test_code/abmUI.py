...
while True:
    ...
    #--------------
    if frame_num < 150:            #Hardcoded value indicating how many frames to let pass once the video begins
        frame_num += 1
...
print("""Time on main loop: {0} secs""".format(round(time.time()-init_time,2)))
